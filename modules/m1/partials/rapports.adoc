 ...
 - [[[AlidadiHeran]]] Alidadi Heran Sacha, _Estimation du volume consommé à partir de capteurs de température_, link:[Bdr Thermea France], CONFIDENTIEL
 
 // xref:attachment$Alidadi Heran-Sacha.pdf[Alidadi Heran-Sacha.pdf],  xref:attachment$Alidadi Heran-Sacha-slides.pdf[Alidadi Heran-Sacha-slides.pdf] 
...
pour les edp_, link:[Irma], link:https://master-csmi.github.io/2023-m1-ktirio-rbenkf/ktirio-rbenkf/index.html[Antora Report : Ktirio-RBEnKF],  xref:attachment$Ballout-Hassan-slides.pdf[Ballout-Hassan-slides.pdf] 
 ...
 - [[[Wade]]] Wade Abdou, _Planification de mouvement_, link:[Irma], https://feelpp.github.io/swimmer/swimmer/latest/StageAbdou/Introduction.html[> Antora Site],  xref:attachment$Wade-Abdou-slides.pdf[Wade-Abdou-slides.pdf]
